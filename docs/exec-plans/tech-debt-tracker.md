...
|---:|------|----------|---------|----------------|------------|-------|------|
| 001 | Docs | Med | Replace monolithic agent guidance with map + structured docs | Reduces drift; improves agent reliability | In progress | unassigned | chore/docs-cleanup-design-principles |
...
|---:|------|-----------|---------|------|
| 005 | Store | 2026-03-10 | Remove dead `tasks.setMyDay()` method | feat/my-day-due-today-and-recurrence-catchup |
