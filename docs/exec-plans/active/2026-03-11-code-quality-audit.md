...
- [ ] Every finding has been triaged (quick-win / medium / needs-plan)
- [ ] Quick wins executed and merged (separate PRs per category)
- [ ] Medium items scheduled or converted to tech debt entries
- [ ] Large items have their own exec plans created
