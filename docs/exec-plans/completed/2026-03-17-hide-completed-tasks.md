...
- 2026-03-17: Fixed toggle layout (checkbox inline with text) and persistence bug (server response was overwriting client-local field). All acceptance criteria met. Plan complete.
